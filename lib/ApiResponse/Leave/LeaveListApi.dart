...
class GetLeaveList{
  ...
  Future<List<LeaveUpdate_Class>> leaveListfun() async {
    int emp_id = 0;
    ...
    if(response.statusCode == 200)
    {
      ...
      print(result);
      return result.map((e) => LeaveUpdate_Class.fromJson(e)).toList();
    }
    else
    {
...
final leaveListProvider = Provider<GetLeaveList>((ref)=>GetLeaveList());